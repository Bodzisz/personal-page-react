...
import { Anchor, Group, Container, useMantineTheme, BackgroundImage } from "@mantine/core";
...
function Footer() {
  ...
  return (
    <BackgroundImage src="/images/waves/footerWave.svg" pt={100} pb={20}>
      <footer className={classes.footer} style={{ position: isMobile ? "unset" : "unset" }}>
